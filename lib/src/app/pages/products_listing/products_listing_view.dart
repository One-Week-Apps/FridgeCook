...
class _ProductsListingRouteState extends ViewState<ProductsListingRoute, ProductsListingController>
  ...
  Widget buildPage() {
    ...
    var recipes = [
      Recipe("Apple pie", ["1 apple"], ["Take an apple"], Image.network("https://media.istockphoto.com/id/184276818/fr/photo/pomme-rouge.jpg?s=612x612&w=0&k=20&c=yk9viCWt8_VHAvSvzPuqZI-A79xkestBMyCf1AEyhrc=", width: 200, height: 200), products),
      Recipe("Orange pie", ["1 orange"], ["Take an orange"], Image.network("https://st.depositphotos.com/1000141/1941/i/600/depositphotos_19418467-stock-photo-ripe-orange-with-leaf.jpg", width: 200, height: 200), products),
      Recipe("Orange pie", ["1 orange"], ["Take an orange"], Image.network("https://st.depositphotos.com/1000141/1941/i/600/depositphotos_19418467-stock-photo-ripe-orange-with-leaf.jpg", width: 200, height: 200), products),
      Recipe("Orange pie", ["1 orange"], ["Take an orange"], Image.network("https://st.depositphotos.com/1000141/1941/i/600/depositphotos_19418467-stock-photo-ripe-orange-with-leaf.jpg", width: 200, height: 200), products),
      Recipe("Orange pie", ["1 orange"], ["Take an orange"], Image.network("https://st.depositphotos.com/1000141/1941/i/600/depositphotos_19418467-stock-photo-ripe-orange-with-leaf.jpg", width: 200, height: 200), products),
      Recipe("Orange pie", ["1 orange"], ["Take an orange"], Image.network("https://st.depositphotos.com/1000141/1941/i/600/depositphotos_19418467-stock-photo-ripe-orange-with-leaf.jpg", width: 200, height: 200), products),
    ...
    var recipesChildren = <Widget>[
      for (var i = 0 ; i < /*controller.*/recipes.length ; i++) _recipeTableViewCell(i, /*controller.*/recipes[i])
    ];
    ...
    return Scaffold(
      ...
      body: _selectedIndex == 0 ? Center(child: Stack(children: [ListView(padding: const EdgeInsets.all(8), children: children), bottomOverlayView]), ) : recipesListingView,
